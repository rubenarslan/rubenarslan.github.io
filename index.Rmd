...
A tutorial is available as a [preprint](https://psyarxiv.com/5qc6h/), but the easiest way to get going is to simply upload a dataset to this [webapp](http://codebook.formr.org/). Iro Eleftheriadou created a [gallery](https://rubenarslan.github.io/codebook_gallery/) for codebooks made from dataset uploaded to the Open Science Framework.
