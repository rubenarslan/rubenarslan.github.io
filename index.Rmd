...
I study genetic and hormonal causes of why people differ and change, especially their personality, intelligence, and sexuality. Open, reproducible science is important to me, so I often work on methods, measures, and transparency and dabble in research software development. I teach research methods at [Witten/Herdecke University](https://www.uni-wh.de/en/contact-person/ruben-lennartz). 

<aside>
<img src="figures/ruben.jpg" class="img-circle" alt="Ruben Arslan">
</aside>

You can reach me at ruben.arslan@gmail.com or on [Bluesky](https://bsky.app/profile/ruben.the100.ci). If you want to tell me I'm wrong about something anonymously, you can use [this form](https://tellmeimwrong.formr.org).^[Some more information about this form can be found [here](http://www.the100.ci/2018/02/22/tell-me-im-wrong).] I also have a standing [bug bounty policy](bug_bounty.html) for errors in my published work.


## Publications
Here's a usually slightly outdated [PDF of my curriculum vitae](cv_ruben_arslan.pdf). All my work is at least green open access and you can find direct links to each publication in this PDF (click on the green/orange lock icons).
You can also find my publications on my [Google Scholar profile](https://scholar.google.com/citations?user=X6fXzMcAAAAJ&hl=en). 

I often make websites to document my analyses and results. You can click on the graphs below to view them.

:::l-body-inset

[![Ovulatory changes in sexual desire across the menstrual cycle](https://rubenarslan.github.io/ovulatory_shifts/library/curves_paper.png){width=100%}](https://rubenarslan.github.io/ovulatory_shifts/)
From 'Using 26 thousand diary entries to show ovulatory changes in sexual desire and behaviour.' (2017), [PDF](https://osf.io/preprints/psyarxiv/jp2ym_v1)

-----

[![Paternal age effects on reproductive fitness](https://rubenarslan.github.io/paternal_age_fitness/library/mcmc_comp.png){width=100%}](https://rubenarslan.github.io/paternal_age_fitness/)
From 'Older fathers’ children have lower evolutionary fitness across four centuries and in four populations.' (2017), [PDF](https://doi.org/10.1098/rspb.2017.1562)


----

[![Genomic effects on intelligence and personality](https://rubenarslan.github.io/generation_scotland_pedigree_gcta/index_files/figure-html/unnamed-chunk-1-31.png){width=100%}](https://rubenarslan.github.io/generation_scotland_pedigree_gcta/)
From 'Genomic analysis of family data reveals additional genetic effects on intelligence and personality' (2018), [PDF](https://www.nature.com/articles/s41380-017-0005-1)

----


[![Voices and Personality](figures/voices_d3.png){width=100%}](https://rubenarslan.github.io/voices_personality/)
From 'Do voices carry valid information about a speaker’s personality?' (2021), [PDF](https://osf.io/preprints/psyarxiv/9a68c_v1)

----


[![Steroid validity results](figures/steroids.png){width=100%}](https://rubenarslan.github.io/invalidity_on_steroids)
From 'Not within spitting distance: salivary immunoassays of estradiol have subpar validity for predicting cycle phase.' (2023), [PDF](https://osf.io/5r8mg_v1)

----


[![SurveyBot3000 pilot study results](https://synth-science.github.io/surveybot3000/Figure_pilot.png){width=100%}](https://synth-science.github.io/surveybot3000/)
From 'Language models accurately infer correlations between psychological items and scales from text alone.' (2025), [PDF](https://doi.org/10.31234/osf.io/kjuce)

----


[![Fragmentation of psychological measures](https://rubenarslan.github.io/construct_proliferation/figures/treemap_overall.png){width=100%}](https://rubenarslan.github.io/construct_proliferation/)
From 'A fragmented field: Construct and measure proliferation in psychology.' (2025), [PDF](https://osf.io/preprints/psyarxiv/b4muj_v3)
...
You have to infer the other person's secret word by asking words, but only learning whether letters matched or not. We kept it very similar to the paper-pencil version that we used to play before it became less common to carry paper and pencil than a smartphone. It predates Wordle.

### [brainfunnel.com](http://beta.brainfunnel.com/)
