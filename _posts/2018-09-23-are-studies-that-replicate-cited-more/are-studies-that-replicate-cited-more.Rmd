...
MASTER <- MASTER %>% mutate(
  citations_after_2018 = citation_count_2018 - Citation.count..paper..O. * 0.82,
...
figure(width = 1100, height = 500) %>%
  ly_points(citations_2015, citations_after_2018, data = MASTER,
...
DT::datatable(MASTER %>% select(-citations_after_2018) %>% arrange(desc(citations_2018)), escape = F)
```
