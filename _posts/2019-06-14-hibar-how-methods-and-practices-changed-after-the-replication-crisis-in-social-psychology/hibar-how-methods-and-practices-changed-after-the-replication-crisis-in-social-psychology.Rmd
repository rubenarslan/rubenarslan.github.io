...
metadata(methods_time)$identifier <- "doi:10.23668/psycharchives.2367"
metadata(methods_time)$datePublished <- "2016-06-01"
metadata(methods_time)$creator <- list(
      "@type" = "Person",
...
metadata(methods_time)$citation <- "Sassenberg, K., & Ditrich, L. (2019). Research in Social Psychology Changed Between 2011 and 2016: Larger Sample Sizes, More Self-Report Measures, and More Online Studies. Advances in Methods and Practices in Psychological Science, 2(2), 107–114. doi: 10.1177/2515245919838781"
metadata(methods_time)$url <- "https://hdl.handle.net/20.500.12034/1999"
metadata(methods_time)$temporalCoverage <- "2016" 
