...
description: |
  Accounting for mistakes in my scientific work and announcing my bug bounty program.
author:
  - name: "Ruben C. Arslan"
...
However, this was a fundamentally dissatisfying experience because I spent more time battling journal submission forms than counter-arguments. I was invited to peer review the critique^[which I didn't like because I didn't feel I should  get to influence whether criticism of my work is published] and pointed out a few factual errors. As a result, the critique that was  published already partially addressed some counterpoints, leading to a quite jumbled argument-counterargument sequence. Then, the journal messed up. After a first round of peer review and then acceptance, they allowed the authors to revise their critique further. The authors substantially changed the text and added two new arguments. Then, the journal sent me an older version to comment on than the one they published. As a result, our reply quotes the commenters three times - and none of those quotes are in the published version - we looked quite sloppy. It took a long time for the journal to acknowledge the mistake, even longer for them to decide how to deal with it. We then had to submit an erratum (apparently, an erratum is for journal errors, corrections are for author errors, in their parlance). The journal then desk-rejected the erratum, because they felt replying to the newly added arguments didn't fit in the erratum. In the end, [this is all they allowed us to publish](http://rspb.royalsocietypublishing.org/content/285/1884/20181427) and the process took more than a month and a lot of nerves. 
