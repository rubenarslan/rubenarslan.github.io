...
From this, we can get the error variance (the variance across draws). Each person can have a different amount of error variance (e.g., people who took part in the dairy for few vs. many days). We also have an estimate of the variance of the true scores (the variance across people within draws). We can then average again (this time, the error variance across people, and the true score variance across draws).
