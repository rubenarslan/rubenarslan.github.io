...
SEE2 <- m1 %>%
      ...
      summarise(
        # weighted SEE^2 reflects the amount of error you get if you take along the uncertainty in your model
        weighted_SEE2 = sum(SEE2*days)/sum(days),
        # unweighted SEE^2 reflects the amount of error you get if you extract the manifest random intercepts/slopes/variances
        SEE2 = mean(SEE2)
        )
```
...
Thanks especially to Stefan Schmukle (who has a related paper draft he really needs to publish), but also Niclas Kupers, Julia Rohrer, and Taym Alsalti for discovering basic mistakes in my thinking and fun exchanges on this topic.
