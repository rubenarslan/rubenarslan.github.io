...
Let me explain. In a recent paper, Killingsworth, Kahneman, and Meller (2023) re-analyze Killingsworth's (2021) experience sampling data to determine the relationship between income and experienced well-being, happiness. I really liked the original Killingsworth (2021) paper, which found a loglinear relationship and attributed Kahneman & Deaton's (2010) finding of a plateau of the income-happiness relationship above $75,000 to a ceiling effect in KD's happiness measure (a binary question repeated 450 times though).

The Killingsworth study had a better happiness measure, a sliding scale from very unhappy to very happy. More than 30,000 subjects rated their happiness 50 times on average. In the reanalysis, KKM wanted to find out why the results differed in an "adversarial collaboration". 
...
Now, I'm not particularly well-acquainted with quantile regression. However, I've worked with multilevel location scale models a good deal in the past. I've learned primarily not to trust my intuition, or at least to calibrate with fake data simulation. So, I simulated.
