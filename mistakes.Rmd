...
__Project:__ [Arslan et al. (2023)](https://dx.doi.org/10.1016/j.psyneuen.2022.105994). Not within spitting distance: Salivary immunoassays of estradiol have subpar validity for predicting cycle phase

__Timing__: After publication.

__Reporter:__ I found this with the help of LLMs Opus 4.5 and Gemini Pro 3.1, because a good question from Stefan Schmukle made me wonder.

__Type of mistake:__ Statistical error that changes imputed numbers slightly.

__Description:__ When we use multiple generated regressors in a regression, we can underadjust for Berkson error if the regressors were generated independently without accounting for residual correlations. I didn't know this and generated my regressor for serum steroids independently, even though there is some residual correlation.

__Delay:__ Three months. After finding the error, I [ran simulations](posts/2026-01-14-berkson-error-why-the-slope-of-your-synthetic-estimates-is-1/) to better understand the problem and reran the Bayesian models I used to generate the regressor as multivariate models with residual correlations. Initially, I found a substantial mismatch, but I also noticed I had subset the data differently (because any missing value in any of the outcomes led to row-wise elimination of data). Once I corrected this, the differences were minor. The analyses are documented [here](http://rubenarslan.github.io/invalidity_on_steroids/5_multivariate_imputations.html).

__Solution:__ I've uploaded the slightly improved multivariate regressors on the [OSF](https://osf.io/u9xad/files/osfstorage) and updated the README. Since the numbers change only very little I don't see the need to do a "recall" for anyone who might've used the numbers and all the numbers in the manuscript itself should be ~correct since they don't use multivariate predictions.
